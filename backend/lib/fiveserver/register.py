...
class RegistrationResource(resource.Resource):
    ...
    def sendHtmlResponse(self, request, message):
        ...
        # In Python 3, getResultContent already returns string if file is opened in text mode
    ...
    def render_POST(self, request):
        ...
        # Python 3: hash is a string, need to encode to bytes first
        hash_bytes = hash.encode('utf-8')
        encrypted = self.cipher.encrypt(binascii.a2b_hex(hash_bytes))
        hash = binascii.b2a_hex(encrypted)
